                ...
                <div className='row'>
                    <div className='col-12'>
                        <div className='container pt-5 d-flex justify-content-center align-items-center'>
                            <div>
                                <h1 className='fw-bold mt-4 text-white'>TRAVEL FOR THOSE <br /> WHO WANT IT ALL</h1>
                                <p className="pb-4 text-white">
                                    I was thinking of doing this but im worried about getting lost being alone, is there markings and are they ok i know there are some, or can i use compass not to get lost.
                                </p>
